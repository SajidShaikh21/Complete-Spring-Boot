...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CategoryAlreadyException.class)
    public ResponseEntity<ExceptionResponseDTO>handleCategoryAlreadyExistException(CategoryAlreadyException ex, WebRequest webRequest)
    {
